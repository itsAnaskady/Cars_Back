        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListeNoir = table.Column<bool>(type: "bit", nullable: true),
                    ListeFavori = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Libellé = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ModePaiments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdVoiture = table.Column<int>(type: "int", nullable: false),
                    IdLocataire = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdModePaiement = table.Column<int>(type: "int", nullable: false),
                    ...
                    Mantant = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdProp = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdMarque = table.Column<int>(type: "int", nullable: false),
                    IdCatego = table.Column<int>(type: "int", nullable: false),
                    NombrePassager = table.Column<int>(type: "int", nullable: false),
